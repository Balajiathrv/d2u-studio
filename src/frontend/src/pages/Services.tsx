    ...
    steps: [
      {
        ...
        title: "Concept Brief",
        description:
          "Deep-dive discovery session to align on your vision, lifestyle needs, and aesthetic preferences.",
      },
      {
        number: "02",
        title: "Mood Boards & Direction",
        description:
          "Visual storytelling through curated mood boards, material references, and colour studies.",
      },
      {
        number: "03",
        title: "3D Visualisation",
        description:
          "Photorealistic renders that let you experience your space before a single item is purchased.",
      },
      {
        number: "04",
        title: "Procurement & Coordination",
        description:
          "End-to-end management of sourcing, ordering, and scheduling deliveries with precision.",
      },
      {
        number: "05",
        title: "Installation & Reveal",
        description:
          "Supervised installation and final styling — we don't leave until every detail is perfect.",
      },
    ],
    benefits: [
    ...
    steps: [
      {
        ...
        description:
          "Site analysis, regulatory review, and initial massing studies to define what's possible.",
      },
      {
        number: "02",
        title: "Schematic Design",
        description:
          "Conceptual floor plans, section sketches, and facade explorations to establish the design direction.",
      },
      {
        number: "03",
        title: "Design Development",
        description:
          "Refined drawings, material specifications, structural coordination, and permit preparation.",
      },
      {
        number: "04",
        title: "Construction Documents",
        description:
          "Comprehensive technical drawing package for contractor tendering and municipal approval.",
      },
      {
        number: "05",
        title: "Site Supervision",
        description:
          "Regular site visits, contractor coordination, and quality assurance through to handover.",
      },
    ],
    benefits: [
    ...
    steps: [
      {
        ...
        title: "Space Audit",
        description:
          "Measured survey, occupancy review, and pain-point analysis of your current layout.",
      },
      {
        number: "02",
        title: "Layout Concepts",
        description:
          "Multiple spatial configurations tested against your brief and workflow requirements.",
      },
      {
        number: "03",
        title: "3D Planning Models",
        description:
          "Digital walkthroughs that reveal how the space will feel before any work begins.",
      },
      {
        number: "04",
        title: "FF&E Integration",
        description:
          "Furniture, fixture, and equipment schedules coordinated directly into the spatial plan.",
      },
      {
        number: "05",
        title: "Handover Package",
        description:
          "Final layout drawings and specifications ready for contractor or fit-out teams.",
      },
    ],
    benefits: [
    ...
    steps: [
      {
        ...
        description:
          "On-site inspection to document existing conditions, identify issues, and establish baseline scope.",
      },
      {
        number: "02",
        title: "Scope of Works",
        description:
          "Detailed brief defining what will be removed, retained, repaired, and replaced.",
      },
      {
        number: "03",
        title: "Material Selection",
        description:
          "Curated finishes, fixtures, and materials that honour the existing fabric while elevating it.",
      },
      {
        number: "04",
        title: "Phased Delivery",
        description:
          "Structured project phasing to minimise disruption and enable partial occupancy if needed.",
      },
      {
        number: "05",
        title: "Final Inspection",
        description:
          "Comprehensive walkthrough, snag resolution, and formal handover with maintenance guidelines.",
      },
    ],
    benefits: [
    ...
    steps: [
      {
        ...
        description:
          "You share plans, photos, references, and questions in advance so we can prepare meaningfully.",
      },
      {
        number: "02",
        title: "Design Review Session",
        description:
          "Structured conversation reviewing your project with expert commentary and recommendations.",
      },
      {
        number: "03",
        title: "Options Analysis",
        description:
          "We present alternatives and help you weigh trade-offs across budget, aesthetic, and programme.",
      },
      {
        number: "04",
        title: "Written Summary",
        description:
          "Post-session notes capturing key decisions, recommendations, and next steps for your records.",
      },
      {
        number: "05",
        title: "Follow-Up Support",
        description:
          "Optional follow-up session or email Q&A to address anything that arises after the meeting.",
      },
    ],
    benefits: [
...
function ServiceSection({
  service,
  idx,
}: { service: ServiceData; idx: number }) {
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Content grid: description + process */}
          <div
            style={{
              display: "grid",
          ...
          >
            {/* Description + Benefits (alternates side) */}
                  ...
                  {service.benefits.map((benefit, benefitIdx) => (
                    <li
                      ...
                      style={{
                        ...
                        borderBottom:
                          benefitIdx < service.benefits.length - 1
                            ? `1px solid ${DIVIDER}`
                            : "none",
                        fontFamily: "'DM Sans', sans-serif",
                        fontSize: "0.875rem",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              From concept to completion, d2u studio delivers considered design
              across five core disciplines — each grounded in craft, detail, and
              a genuine understanding of how people inhabit space.
            </p>
          </motion.div>
        </div>
      ...
      <section style={{ background: BG, padding: "6rem 2rem" }}>
        ...
        >
          ...
          >
            ...
            <em style={{ fontStyle: "italic", color: GOLD }}>remarkable</em>{" "}
            together
          </h2>
          ...
          >
            Tell us about your project and we'll respond within 24 hours. No
