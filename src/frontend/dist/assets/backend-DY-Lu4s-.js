...
const Stat = Record({ "title": Text, "value": Text });
Service({
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Stat2 = IDL2.Record({ "title": IDL2.Text, "value": IDL2.Text });
  return IDL2.Service({
    ...
    "getStats": IDL2.Func([], [IDL2.Vec(Stat2)], ["query"]),
    ...
    "updateStats": IDL2.Func([IDL2.Vec(Stat2)], [], []),
