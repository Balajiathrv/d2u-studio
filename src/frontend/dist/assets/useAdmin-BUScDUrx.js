import { r as reactExports, j as jsxRuntimeExports, R as React, e as clsx, c as cn, a as useQueryClient } from "./index-DzRidtFL.js";
import { c as composeRefs } from "./index-CPwCoacN.js";
...
function useChangeAdminCredentials() {
  const { actor } = useActor(createActor);
  return useMutation({
...
function useAdminProjects() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return [];
      return actor.listProjects(null);
    },
    enabled: !!actor && !isFetching
  });
}
...
export {
  Button as B,
  Slot as S,
  useAdminSession as a,
  useAdminProjects as b,
  useAdminInquiries as c,
  useHeroImages as d,
  useAddHeroImage as e,
  useRemoveHeroImage as f,
  useDeleteProject as g,
  useToggleFeatured as h,
  useCreateProject as i,
  useUpdateProject as j,
  cva as k,
  useChangeAdminCredentials as l,
  createSlot as m,
  useValidateAdmin as u
};
